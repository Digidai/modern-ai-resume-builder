...
const ResumePreview: React.FC<ResumePreviewProps> = ({ data }) => {
  ...
  const wrapperClass = "resume-preview-container bg-white text-slate-900 w-full h-full min-h-[29.7cm] shadow-xl print:shadow-none p-12 md:p-16 print:p-[1.5cm] overflow-hidden relative flex flex-col";
  ...
  const containerClass = isFullBleed
    ? "resume-preview-container bg-white text-slate-900 w-full h-full min-h-[29.7cm] shadow-xl print:shadow-none overflow-hidden flex flex-col"
    : wrapperClass;
