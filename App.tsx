...
import { DownloadIcon, EditIcon, CheckIcon, ArrowLeftIcon } from './components/Icons';
        ...
        `}>
          <div className="h-full flex flex-col gap-4">
            ...
            <div className="text-center text-xs text-slate-400 py-2">
               Press <span className="font-mono bg-slate-200 px-1 rounded">Cmd/Ctrl + P</span> to export
            </div>
          </div>
        </aside>

        {/* Main Content / Preview */}
        <main className="flex-1 relative overflow-y-auto h-screen custom-scrollbar print:h-auto print:overflow-visible">
          <div className="max-w-[21cm] mx-auto my-8 print:my-0 print:mx-0 print:w-full">
